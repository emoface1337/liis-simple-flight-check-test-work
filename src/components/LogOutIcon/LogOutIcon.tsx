...
const LogOutIcon: FC = (): ReactElement => {
    return (
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M15 16L20 11L15 6" stroke="#1157A7" strokeWidth="2.2" strokeLinecap="round"
                  strokeLinejoin="round"/>
            <path d="M20 11H8" stroke="#1157A7" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
